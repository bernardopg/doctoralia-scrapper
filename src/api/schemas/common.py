...
class UnifiedResult(BaseModel):
    ...
    generation: Optional[GenerationResult] = Field(None, description="Generated responses")
    metrics: Metrics = Field(..., description="Performance metrics")
    job_id: Optional[str] = Field(None, description="Async job ID")
    status: str = Field(..., description="Operation status", pattern="^(completed|failed|running)$")
