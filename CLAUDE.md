...
This project is indexed by GitNexus as **doctoralia-scrapper** (4269 symbols, 7125 relationships, 200 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/doctoralia-scrapper/context` | Codebase overview, check index freshness |
| `gitnexus://repo/doctoralia-scrapper/clusters` | All functional areas |
| `gitnexus://repo/doctoralia-scrapper/processes` | All execution flows |
| `gitnexus://repo/doctoralia-scrapper/process/{name}` | Step-by-step execution trace |
